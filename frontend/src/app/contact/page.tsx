...
const CONTACT_CARDS = [
  {
    ...
    label: 'support@afrilaunchhub.com',
    href: 'mailto:support@afrilaunchhub.com',
    icon: (
  ...
  },
  {
    ...
    label: 'hello@afrilaunchhub.com',
    href: 'mailto:hello@afrilaunchhub.com',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    label: 'partners@afrilaunchhub.com',
    href: 'mailto:partners@afrilaunchhub.com',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="min-h-screen bg-background text-text-dark">
        ...
        <footer className="border-t border-gray-200 bg-white py-8">
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mt-6 text-center text-sm text-gray-500">© {new Date().getFullYear()} AfriLaunch Hub.</p>
          </div>
        </footer>
      </div>
    );
