...
export default function TalentMarketplacePage() {
  ...
  useEffect(() => {
    const url = skillFilter
      ? `${API_BASE}/api/v1/talent/marketplace?skills=${encodeURIComponent(skillFilter)}`
      : `${API_BASE}/api/v1/talent/marketplace`;
    fetch(url)
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <div className="flex gap-2">
            <input
              type="text"
              placeholder="Filter by skill (e.g. design, frontend)"
            ...
            {items.map((t) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500 mt-0.5">
                  {t.customRole || t.skills.slice(0, 3).join(', ')} · {t.yearsExperience} years exp.
                </p>
