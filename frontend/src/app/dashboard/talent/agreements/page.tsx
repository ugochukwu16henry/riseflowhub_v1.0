...
export default function TalentAgreementsPage() {
  ...
  return (
    <div className="p-6 max-w-4xl">
      ...
      {loading ? <p className="text-gray-500">Loading...</p> : list.length === 0 ? <p className="text-gray-500">No agreements assigned to you.</p> : (
        <ul className="space-y-2">
          {list.map((a: { id: string; title: string; status: string }) => (
