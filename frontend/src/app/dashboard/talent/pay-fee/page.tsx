...
export default function TalentPayFeePage() {
  ...
  async function handlePay() {
    ...
    setLoading(true);
    try {
      const r = await api.marketplaceFee.createSession({ type: 'talent_marketplace_fee' }, token);
  ...
  return (
    <div className="p-6 max-w-md">
      ...
      <p className="text-gray-600 mb-4">One-time $7 fee to showcase your profile in the Talent Marketplace. Simulated payment — in production this would use Stripe.</p>
