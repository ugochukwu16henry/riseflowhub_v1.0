...
export function teamInviteEmail(data: TeamInviteData & Record<string, unknown>): { subject: string; html: string } {
  ...
  const subject = 'You\'re invited to join AfriLaunch Hub';
  const html = `
    <div style="font-family: system-ui, sans-serif; max-width: 560px; margin: 0 auto;">
      <h2 style="color: #0f172a;">You're invited to the team</h2>
      <p style="color: #475569; line-height: 1.6;">${inviterName} has invited you to join AfriLaunch Hub as <strong>${role}</strong>.</p>
